export const upcomingEventLogos = ["/event-logos/field_day_2.jpg"];
export const upcomingEventLinks = ["https://docs.google.com/forms/d/1K9-IcUQsjNAHR9n5aFxCHzhuaVX2rKbU1-25iVOeKQA/viewform?edit_requested=true"];
